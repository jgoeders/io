...
uint8_t button_up() { return bcm2835_gpio_lev(KEY_UP_PIN); }

uint8_t button_down() { return bcm2835_gpio_lev(KEY_DOWN_PIN); }

uint8_t button_left() { return bcm2835_gpio_lev(KEY_LEFT_PIN); }

uint8_t button_right() { return bcm2835_gpio_lev(KEY_RIGHT_PIN); }
